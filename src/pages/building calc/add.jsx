...
function AddBuildingCalcPage() {
  ...
  async function AddBuildingCalc() {
    setLoading(true);

    await fetch(SYSTEM_URL + "create_building_calc/", {
      method: "POST",
      headers: {
      ...
      .then((data) => {
        alert("تم اضافة سجل ");
        navigate("/building_calcs", { replace: true });
      })
      .catch((error) => {
        console.log(error);
        alert(error + "😕");
...
export default AddBuildingCalcPage;
